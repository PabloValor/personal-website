...
}(jQuery,ytp),$(document).on("ready",function(){"use strict";{var e=$("#header"),r=$("#arrow");$("section")}e.height($(window).height()),r.on("click",function(r){r.preventDefault(),$("html, body").animate({scrollTop:e.height()},1500)}),$(".player").mb_YTPlayer(),console.log("ready :)")});